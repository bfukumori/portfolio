...
export function HeroSection() {
  ...
  const cvFile = locale === "pt" ? "/Resume_PT.pdf" : "/Resume_EN.pdf";
  const cvFileName =
    locale === "pt"
      ? "Bruno_Fukumori_CV_PT.pdf"
      : "Bruno_Fukumori_Resume_EN.pdf";
        ...
        <div className="lg:col-span-7 flex flex-col items-start">
          ...
          <p className="text-base sm:text-lg text-zinc-300 leading-relaxed max-w-2xl mb-8">
            {locale === "pt" ? (
              <>
                ...
                , <strong className="text-zinc-100 font-semibold">React</strong>{" "}
                e{" "}
                <strong className="text-zinc-100 font-semibold">
                  React Native/Expo
                </strong>
                ). Experiência comprovada em portais de saúde atendendo mais de
                2 milhões de vidas e governança corporativa no mercado
                financeiro.
              </>
            ) : (
              <>
                Specialist in modern ecosystems (
                <strong className="text-zinc-100 font-semibold">
                  Node.js/Next.js
                </strong>
                , <strong className="text-zinc-100 font-semibold">React</strong>{" "}
                ...
                ). Proven track record in healthcare portals serving over 2
                million lives and corporate governance in the financial market.
              </>
            )}
          </p>
          ...
          <div className="flex flex-wrap items-center gap-4 text-xs sm:text-sm text-zinc-400">
            ...
            <div className="flex items-center gap-1.5 text-zinc-400">
              ...
              <span>{t.hero.locationDetails}</span>
            </div>
          </div>
        </div>
              ...
              <div className="mt-4 rounded-2xl border border-zinc-800/80 bg-zinc-900/60 p-4 backdrop-blur-xs">
                <div className="flex flex-col mb-2.5">
                  ...
                  <span className="text-xs text-zinc-400 font-medium">
                    {t.hero.tagline} • {t.hero.cardSubtitle}
                  </span>
                </div>
